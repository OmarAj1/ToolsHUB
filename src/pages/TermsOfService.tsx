...
export function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 text-slate-50 text-slate-50">
      <h1 className="text-3xl font-bold mb-8 text-slate-50 text-white">Terms of Service</h1>
      
      <div className="space-y-6 text-slate-50 text-slate-50 leading-relaxed">
        <section>
          <h2 className="text-xl font-semibold mb-3 text-slate-50 text-slate-50">1. Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-slate-50 text-slate-50">2. Use of Service</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-slate-50 text-slate-50">3. User Responsibilities</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-slate-50 text-slate-50">4. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-slate-50 text-slate-50">5. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-slate-50 text-slate-50">6. Modifications to Service</h2>
          <p>
